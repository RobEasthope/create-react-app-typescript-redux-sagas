...
export const fetchSuccess = (data: Team[]) =>
  action(TeamsActionTypes.FETCH_SUCCESS, data);
export const fetchError = (message: string) =>
  action(TeamsActionTypes.FETCH_ERROR, message);
export const selectTeam = (team_id: string) =>
  action(TeamsActionTypes.SELECT_TEAM, team_id);
